...
#             print "LR: Forecast values obtained for php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast)

        except Exception as e:
            forecast.append(0)
            print "ERROR calculating the LR for the php_resp_time values with php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast) + " " + str(e)
...
#             print "Vector_auto_regression: Forecast values obtained for php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast)

        except Exception as e:
            forecast = []
            forecast.append(0)
            print "ERROR calculating the VAR for the php_resp_time values with php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast) + " " + str(e)

        return forecast

    def load_data(self, php_resp_time, cpu_load):
        if (len(php_resp_time) != len(cpu_load)):
            print "load_data: data arrays must have the same number of elements."
...
#             print "OLS Regression: Forecast values obtained for php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast)
        except Exception as e:
            forecast.append(0)
            print "ERROR calculating the LR_OLS for the php_resp_time values with php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast) + " " + str(e)
...
#             print "Multiple Regression: Forecast values obtained for php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast)
        except Exception as e:
            forecast.append(0)
            print "ERROR calculating the Multiple Regression for the php_resp_time values with php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast) + " " + str(e)
    ...
    def auto_regression(self, php_resp_time, num_predictions):
         ...
         try:
            ...
            ar_model = sm.tsa.AR(endog, dates=dates)
            ar_model = ar_model.fit(maxlag=9, method='mle', disp=False)
...
#             print "AR: Forecast values obtained for php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast)

         except Exception as e:
             forecast = []
             forecast.append(0)
             print "ERROR calculating the AR for the php_resp_time values with php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast) + " -- " + str(e)
             import os, sys
...
#             print "ARMA: Forecast values obtained for php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast)

        except Exception as e:
            forecast = []
            forecast.append(0)
            print "ERROR calculating the ARMA for the php_resp_time values with php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast) + " " + str(e)
...
#             print "Exponential Smoothing: Forecast values obtained for php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast)

        except Exception as e:
            forecast.append(0)
            print "ERROR calculating the EXP. SMOOTHING for the php_resp_time values with php_resp_time[0]: " + str(php_resp_time[0]) + " --> " + str(forecast) + " " + str(e)
