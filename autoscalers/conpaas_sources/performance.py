...
class ServiceNodePerf(object):
    ...
    def update_online_web_coefficients(self):
        ...
        print 'Updated coefficients for online web profiling: ' + str(self.oweb_coeffs)
    ...
    def update_online_backend_coefficients(self):
        ...
        print 'Updated coefficients for online web profiling: ' + str(self.oback_coeffs)
    ...
    def compute_resp_time_prediction(self, request_rate, profile, coeffs):
        ...
        print 'Response time prediction: index ' + str(idx) + ' predicted value: ' + str(prediction)
        return prediction
    ...
    def compute_req_rate_prediction(self, target_resp_time, profile, coeffs):
        ...
        print 'Request rate prediction: index ' + str(idx) + ' predicted value: ' + str(predicted_req_rate)
